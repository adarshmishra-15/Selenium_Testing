...
public class FillingFormAndErrorMsgPrint {
/*
 * To open course era
 * scroll down
 * Click For campus
 * then go to form 
 * fill data using apache poi
 * 
 */
		...
		public static String cellData(int rowNum, int colNum) {
			...
			try {
				FileInputStream file = new FileInputStream(
						"C:\\Users\\2373664\\eclipse-workspace\\Testingous\\testdata\\HandsOn_Project.xlsx"); //It opens the excel file as we have provided the path here
